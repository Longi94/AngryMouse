...
namespace AngryMouse {
   ...
   public partial class OverlayWindow {
      ...
      private void Window_Loaded(object sender, RoutedEventArgs e) {
         ...
         Angry.RenderTransform = transformGroup;
      ...
      private void OnMouseMove(object sender, MouseEventExtArgs e) {
         ...
         var visible = mouseInScreen ? Visibility.Visible : Visibility.Hidden;
         Angry.Visibility = !Properties.Settings.Default.Angry ? Visibility.Collapsed : visible;
         BigCursor.Visibility = visible;
         if (!mouseInScreen) {
            return;
         }
